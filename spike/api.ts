...
import type { Result, ValueOptions, ProjectionOptions, ValueKind, DerivedKind, JsonSchema, LiteralKind } from '../src/types.js';
export declare function defineValue<const K extends string, W extends z.ZodType, P>(spec: {
