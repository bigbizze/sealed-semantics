...
16. Derived equality is identity. Independently produced values remain distinct keys in IdMap and IdSet; repeated use of the same instance agrees with identity.
