...
- Snapshotting now uses a measured hot-path optimization for ordinary objects and arrays. Sorting was not the main cost; descriptor reads and per-property definition were the larger avoidable costs.
